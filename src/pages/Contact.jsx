  ...
  return (
    ...
    <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-28'>
      ...
      <div className='flex flex-col justify-center items-start gap-6'>
        ...
        <p className='text-gray-500'>1209 Sattmoshjid Road <br/> Dhanmondi, Dhaka, Bangladesh</p>
        <p className='text-gray-500'>Tel: 01954496221 <br/> Email: nayemkhan4496@gmail.com</p>
