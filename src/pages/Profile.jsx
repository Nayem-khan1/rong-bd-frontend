    ...
    <div className="border-t border-gray-300 pt-16">
      ...
      <div className="py-4 border-t border-gray-300 text-gray-700 flex flex-col md:flex-row items-center gap-6">
        ...
        <div>
          <button
            onClick={() => logOut()}
            className="flex items-center border border-black px-4 py-2 text-base font-medium hover:bg-black hover:text-white transition-all duration-500 cursor-pointer"
          >
            <span>Logout</span>
